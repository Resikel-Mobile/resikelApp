...
@Composable
fun onBoardingTiga(modifier: Modifier = Modifier,navController: NavController) {
    Column(Modifier.fillMaxSize()) {
        Box(
            modifier = Modifier.fillMaxSize(),
        ) {
            Image(
                painter = painterResource(R.drawable.image_boardingtiga),
            ...
            Column(
                ...
                Row(
                    ...
                    Button(
                        shape = RoundedCornerShape(10.dp),
                        onClick = { navController.navigate("onBoardingEmpat") },
                        modifier = Modifier
                            .height(64.dp)
                            .width(140.dp),
                        colors = ButtonDefaults.buttonColors(
...
@Preview
@Composable
private fun preonBoardingTiga() {
    onBoardingTiga(navController =  rememberNavController())
}